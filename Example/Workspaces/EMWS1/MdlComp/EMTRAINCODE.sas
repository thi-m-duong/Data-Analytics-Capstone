...
retain parent "Reg" MODEL "Reg" MODELDESCRIPTION "Regression" TARGETLABEL "RESPOND";
...
retain parent "AutoNeural" MODEL "AutoNeural" MODELDESCRIPTION "AutoNeural" TARGETLABEL "RESPOND";
